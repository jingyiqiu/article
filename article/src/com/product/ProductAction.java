...
public class ProductAction extends HttpServlet {
	...
	private void addProduct(HttpServletRequest request, HttpServletResponse response) 
		...
		//		 String	upFile = uploadFile.substring(uploadFile.lastIndexOf("\\")+1);  
					
					char indexChar = '\\';  
                    String fileName = fileItem.getName().substring(imageName.lastIndexOf(indexChar) + 1,  
                    		imageName.length());  
					...
					System.out.println("---upload_dir--->>"+saveFile);
